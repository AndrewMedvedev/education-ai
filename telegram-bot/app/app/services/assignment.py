...
from app.core.entities.course import AnyAssignment, AssignmentType
from app.infra.ai.agents.course_generator.schemas import TeacherContext
from app.infra.ai.agents.course_generator.subagents.practician import call_practice_agent
from app.infra.db.conn import session_factory
from app.infra.db.repos import CourseRepository, ModuleRepository, StudentRepository
from app.utils.formatting import get_assignment_context, get_module_context
