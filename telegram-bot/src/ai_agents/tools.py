...
async def browse_page(link: str) -> str:
    return await crawler.crawl_page_content(link)
...
class CodeWriterInput(BaseModel):
    ...
    prompt: str = Field(description="Тво` техническое задание или запрос для написания кода")
...
tools = [rutube_search, web_search, browse_page, draw_mermaid, write_code]
